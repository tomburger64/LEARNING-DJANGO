...
This way, I'll practice my python and also dive into backend for a framework that's pretty well documented over the web (as a high level language / reputed to be the "easiest" framework to learn in terms of learning curve, which's probably the best considering my background of no backend taught in 2 years of IT school 🔥🔥)
